...
class SQLNetCondPredictor(nn.Module):
    def __init__(self, N_word, N_h, N_depth,
                 max_col_num, max_tok_num, use_ca, gpu):
    ...
    def forward(self, x_emb_var, x_len, col_inp_var, col_name_len,
        ...
        e_num_col, col_num = col_name_encode(
            col_inp_var, col_name_len, col_len, self.cond_num_name_enc)
        ...
        e_cond_col, _ = col_name_encode(
            col_inp_var, col_name_len, col_len, self.cond_col_name_enc)
        ...
        if gt_where is not None:
            ...
            while t < 50:
                ...
                _, ans_tok_var = cur_cond_str_score.view(
                    B * 4, max_x_len).max(1)
